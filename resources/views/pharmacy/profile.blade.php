...
<x-dash.master>
    ...
    <form action="{{ route('pharmacy.profile') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="flex flex-wrap -mx-3">
            <div class="w-full md:w-1/4 px-3 mb-6">
                @php
                    $src = $pharmacy->image
                        ? asset('storage/pharmacy/' . $pharmacy->image->path)
                        : 'https://ui-avatars.com/api/?background=random&name=' . $pharmacy->name;
                @endphp
            ...
            <div class="w-full md:w-2/4 px-3">
                ...
                <div class="mb-4">
                    ...
                    <input type="text"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        name="address" value="{{ old('address', $pharmacy->address) }}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        name="description" value="{{ old('description', $pharmacy->description) }}">
                </div>
    ...
    <script>
        ...
        window.App = {
            ...
            profileRoute: '{{ route('pharmacy.profile') }}'
        };
    </script>
    <script src="{{ asset('backend/js/pharmacy/profile.js') }}"></script>
@endpush
</x-dash.master>
